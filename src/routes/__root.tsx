...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pencer — Track your train & ferry rides" },
      ...
      { name: "apple-mobile-web-app-title", content: "Pencer" },
      { property: "og:title", content: "Pencer — Track your train & ferry rides" },
      ...
      { name: "twitter:title", content: "Pencer — Track your train & ferry rides" },
